...
import xmltodict
from equation.Equation import Equations, Equation
...
class Problem:
    ...
    def get_problems(self, level: int = None) -> None:
        ...
        On enregistre la liste dans la structure lst_problems, on accède à un élément problème par son indice
    ...
    def get_equation(self, id: int = None) -> None:
    ...
    def get_values(self):
        ...
        def _analyse_calcul():
            ...
            # On parcourt chaque attribut #xxx# et on renvoie un tuple avec la valeur et la precision
            for index, elt in enumerate(attributes):
                grandeur = {}
                nom = elt[0]
                if nom[0] == 'M':  # masses molaires
                    indice = int(nom[2]) if nom[1] == 'r' else int(nom[2]) + len(self.equation.reactifs)
                    ...
                    grandeur['valeur'], grandeur['lim'], grandeur['slim'], grandeur['precision'] = self.calc_xmax()
    ...
    def calc_xmax(self) -> tuple:
        ...
        """
        # calcul de xmax
        nb_reactifs = len(self.equation.reactifs)
            ...
            if key[0] in ['n', 'm']:
                ...
                if self.values[key]:
                    if key[0] == 'n':
                        ...
                        rapports.append(self.values[key]*self.values[coeff] / (self.equation.massesmolaires[indice]))
