...
exports.init_tableau = function() {
    eq = JSON.parse(sessionStorage.equation)
    ...
    $('#tb_bt_helpAvancement').on('click',function(){
        ...
        $("#tb_tab_avancement_help1").on('click',null,{titre: txt.TB_LIMITANT, info: msg.TB_LIMITANT_TEXT1,
             container: '#tb_limitant_exemple', btclose: txt.TB_BT_LIMITANT_CLOSE, math: true},utils.dsp_modal_info)
        $("#tb_tab_avancement_help2").on('click',null,{titre: txt.TB_LIMITANT, info: msg.TB_LIMITANT_TEXT2,
             container: '#tb_limitant_exemple', btclose: txt.TB_BT_LIMITANT_CLOSE, math: true},utils.dsp_modal_info)
    })
